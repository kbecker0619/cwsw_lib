...
${OBJECTDIR}/app/main.o: app/main.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DXPRJ_NB_${CONF} -Icwsw_lib -Icfg -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/app/main.o app/main.c
...
${OBJECTDIR}/app/main_nomain.o: ${OBJECTDIR}/app/main.o app/main.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Wall -DXPRJ_NB_${CONF} -Icwsw_lib -Icfg -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/app/main_nomain.o app/main.c;\
	else  \
